...
function pressEquals() {
  let expression = outputLower.innerHTML;
  outputUpper.innerHTML = expression;
...
document.addEventListener("keydown", function (e) {
  switch (e.key) {
    ...
    case "/":
      ...
      break;
    case ".":
      pressDot(document.querySelector("button:nth-child(17)"));
      break;
    case "(":
      pressDot(document.querySelector("button:nth-child(18)"));
      break;
    case ")":
      pressDot(document.querySelector("button:nth-child(19)"));
      break;
    case "Enter":
      e.preventDefault();
      pressEquals();
